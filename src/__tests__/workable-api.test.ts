  ...
  describe("getCandidates", () => {
    it("should fetch all pages of candidates", async () => {
      ...
      const firstPageResponse = {
        data: {
          ...
          paging: {
            next: "https://test-company.workable.com/spi/v3/jobs/SE001/candidates?limit=100&after=cursor123",
          },
        },
        headers: {
          "x-rate-limit-limit": "10",
      ...
      const secondPageResponse = {
        data: {
          candidates: [{ id: "3", email: "user3@example.com", name: "User 3" }],
          paging: { next: null },
        },
        headers: {
          "x-rate-limit-limit": "10",
    ...
    it("should handle single page of candidates", async () => {
      const singlePageResponse = {
        data: {
          candidates: [{ id: "1", email: "user1@example.com", name: "User 1" }],
          paging: { next: null },
        },
        headers: {
          "x-rate-limit-limit": "10",
